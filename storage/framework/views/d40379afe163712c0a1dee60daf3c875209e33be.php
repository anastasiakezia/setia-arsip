<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
    ...
    <img class="img-fluid" src="/admin/assets/img/logo_rs.jpg" style="max-width: 2.25rem;margin-left: 5px;" />
    <a class="navbar-brand pe-3 ps-4 ps-lg-2" style="font-size: 22px" href="<?php echo e(route('admin-dashboard')); ?>">
        SeTIA
    </a>
    <!-- Navbar Search Input-->
...
</nav><?php /**PATH C:\laragon\www\setia-arsip\resources\views/includes/navbar-admin.blade.php ENDPATH**/ ?>