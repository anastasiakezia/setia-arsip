                    ...
                    <table class="table table-striped table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;font-size: small;"><?php echo e($letter->letter_no); ?></td>
                                <td style="text-align: center;font-size: small;"><?php echo e($letter->sender_name); ?></td>
                                <td style="text-align: center;font-size: small;"><?php echo e($letter->regarding); ?></td>
                                <td style="text-align: center;font-size: small;"><?php echo e(Carbon\Carbon::parse($letter->letter_date)->translatedFormat('l, d F Y')); ?></td>
                                <td style="text-align: center;font-size: small;"><?php echo e(Carbon\Carbon::parse($letter->date_received)->translatedFormat('l, d F Y')); ?></td>
                                <td style="text-align: center;font-size: small;"><?php echo e($letter->disposisi); ?></td>
                            </tr>
...
</html><?php /**PATH C:\laragon\www\setia-arsip\resources\views/pages/admin/letter/print-incoming.blade.php ENDPATH**/ ?>