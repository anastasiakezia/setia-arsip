...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 row">
                                <label for="letterout_type" class="col-sm-3 col-form-label">Jenis Surat Keluar</label>
                                <div class="col-sm-9">
                                    <select name="letterout_type" class="form-control" id="letterout_type" required>
                                        <option value="">Pilih Jenis Surat Keluar..</option>
                                        <option value="Biasa">Surat Edaran</option>
                                        <option value="Penting">Surat Pemberitahuan</option>
                                        <option value="Rahasia">Surat Permohonan</option>
                                        <option value="Segera">Surat Keterangan</option>
                                        <option value="Segera">Surat Tugas</option>
                                        <option value="Segera">Surat Rekomendasi</option>
                                        <option value="Segera">Surat Kuasa</option>
                                        <option value="Segera">Pakta Integritas</option>
                                        <option value="Segera">Surat Balasan/Tindak Lanjut</option>
                                    </select>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 row">
                                <label for="letterout_name" class="col-sm-3 col-form-label">Nama Surat</label>
                                <div class="col-sm-9">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\arsip-iahn\resources\views/pages/admin/letterout/create.blade.php ENDPATH**/ ?>