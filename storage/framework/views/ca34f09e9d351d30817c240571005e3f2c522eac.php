            ...
            <form action="<?php echo e(route('department.update', $item->id)); ?>" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <div class="col-md-12">
                            <label for="post_id">Nama Departemen</label>
                            <input type="text" name="name" value="<?php echo e($name); ?>" class="form-control" placeholder="Masukan Nama Departemen.." required>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\arsip-iahn\resources\views/pages/admin/department/index.blade.php ENDPATH**/ ?>