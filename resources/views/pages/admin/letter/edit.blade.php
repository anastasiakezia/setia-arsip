                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="letter_char" class="form-control" id="letter_char" required value="{{ $item->letter_char }}">
                                        <option value="">Pilih Sifat Surat..</option>
                                        <option value="Biasa" {{ $item->letter_char == 'Biasa' ? 'selected' : '' }}>Biasa</option>
                                        <option value="Penting" {{ $item->letter_char == 'Penting' ? 'selected' : '' }}>Penting</option>
                                        <option value="Rahasia" {{ $item->letter_char == 'Rahasia' ? 'selected' : '' }}>Rahasia</option>
                                        <option value="Segera" {{ $item->letter_char == 'Segera' ? 'selected' : '' }}>Segera</option>
                                    </select>
                                </div>
                                @error('letter_char')
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('sender_name') is-invalid @enderror" value="{{ $item->sender_name }}" name="sender_name" placeholder="Isi Pengirim Surat.." required>
                                </div>
                                @error('sender_name')
                                <div class="invalid-feedback">
                                    {{ $message; }}
